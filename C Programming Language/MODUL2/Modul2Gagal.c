#include <stdio.h>
#include <string.h> //strcpy, strncpy, strcat, strncat, strcmp, strncmp, strlen.
#include <conio.h>
    ...
    do
    {
        if (c == 1)
        {
            ...
            case 1:
            {
                ...
                {
                    int num;
                    printf("Sandisk Flashdisk 64 Gb Seharga 60000 . Yakin Ingin Membeli?.Jika 'Setuju' Ketik 1, Jika ketik apapun\n");
                    scanf("%d", &num);
                    if (num == 1)
                    {
                        a[2]++;
            ...
            {
                int id;
                printf("Masukkan ID untuk menghapus Item\n");
                scanf("%d", &id);
                if (id < 9 && id > 0)
                {
                ...
                printf("ID\tItem\t\t\tKuantitas\t\tHarga\n");
                for (i = 0; i < 9; i++)
                {
                    if (a[i] != 0)
                    {
